...
## 📝 Log Perbincangan & Pra-Pembangunan (Logbook)

### [20/04/2026] - Sesi Brainstorming & Hala Tuju
- **Aktiviti:** Perbincangan awal bersama pihak pengurusan mengenai keperluan mempunyai portal rasmi.
- **Tindakan:** Mengenal pasti masalah ketiadaan website rasmi dan mencadangkan penggunaan GitHub untuk simpanan rekod kod (version control).

### [21/04/2026] - Pemilihan Konsep & Struktur Visual
- **Aktiviti:** Mencari kerangka (template) yang sesuai dengan imej korporat Arrahnu.
- **Tindakan:** Menilai beberapa template daripada HTML5 UP. Memilih template **Solid State** kerana strukturnya yang kemas dan profesional.

### [22/04/2026] - Penyesuaian Identiti Korporat (Skema Warna)
- **Aktiviti:** Perbincangan mengenai penukaran warna tema template asal.
- **Tindakan:** Mencadangkan pertukaran warna daripada Biru (asal) kepada tona Merah dan Emas (Gold) supaya selari dengan logo dan identiti Arrahnu Prihatin.

### [23/04/2026] - Rundingan Lesen & Hak Cipta
- **Aktiviti:** Meneliti aspek perundangan dan penggunaan template pihak ketiga.
...
## ⚖️ Status Lesen
Laman web ini akan dilesenkan di bawah **Hak Milik Terpelihara Arrahnu Prihatin**.
